...
4. In the **Create dedicated SQL pool** page, enter **`SQLPool01`** (You <u>must</u> use this name exactly as displayed here) for the pool name, then set the performance level to **DW100c**. Click **Review + create**. Select **Create** on the validation step.
